from dailyDecisionPackage.dailyDecision import (
    pick_color,
    pick_activity,
    pick_clothes,
    pick_food,
...
print("-" * 70)
pick_activity(weather="sunny")
print()

print("Example 4.3: Only energy level provided")
print("-" * 70)
pick_activity(energy_level="high")
print()

print("Example 4.4: Both weather and energy level provided")
print("-" * 70)
pick_activity(weather="snowy", energy_level="low")
print()
